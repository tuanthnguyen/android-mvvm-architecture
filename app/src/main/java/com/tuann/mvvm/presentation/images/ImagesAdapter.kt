...
import com.tuann.mvvm.presentation.view.DataBoundListCustomAdapter
...
class ImagesAdapter(
    ...
    override fun createBinding(parent: ViewGroup, viewType: Int): ViewDataBinding {
        ...
        val layoutId = when (viewType) {
            ItemType.ITEM.value -> R.layout.item_image
    ...
    override fun getItemViewType(position: Int) =
        if (position == itemCount - 1) ItemType.MORE.value else ItemType.ITEM.value
}